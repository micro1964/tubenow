#define NGX_CONFIGURE " --add-module=/home/tubenow/nginx/nginx-rtmp-module/ --with-http_ssl_module --prefix=/usr/local/nginx-streaming/"
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/usr/local/nginx-streaming//"
#endif
